"""
Django settings for gxp_38842 project.
...
WSGI_APPLICATION = 'gxp_38842.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "gxp_38842 API",
    "DESCRIPTION": "API documentation for gxp_38842 App",
    "VERSION": "v1",
}
